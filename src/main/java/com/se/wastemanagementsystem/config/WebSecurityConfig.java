...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.cors().and().csrf().disable().exceptionHandling()
				...
				.authorizeRequests()
				.and()
				.antMatcher(pathPattern).authorizeRequests().anyRequest().authenticated();
		httpSecurity.addFilterBefore(filterInterceptor, UsernamePasswordAuthenticationFilter.class);
	}
}
